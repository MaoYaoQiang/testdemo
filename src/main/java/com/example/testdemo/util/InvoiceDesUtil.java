...
public class InvoiceDesUtil {
    ...
    public static String encrypt(String xmlStr,String mkey) {
        ...
        byte[] md5Hasn = null;
        try {
            md5Hasn = InvoiceDesUtil.MD5Hash(encrypt, 0, encrypt.length);
        } catch (Exception e) {
            e.printStackTrace();
        }
        // 组合消息体
        byte[] totalByte = InvoiceDesUtil.addMD5(md5Hasn, encrypt);
        ...
        byte[] temp = null;
        try {
            temp = InvoiceDesUtil.DES_CBC_Encrypt(totalByte, deskey, ivParam);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static String decrypt(String xmlStr,String mKey) throws Exception {
        ...
        byte[] temp = null;
        try {
            temp = InvoiceDesUtil.DES_CBC_Decrypt(encBuf, deskey, ivParam);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        byte[] md5Hash = null;
        try {
            md5Hash = InvoiceDesUtil.MD5Hash(temp, 16, temp.length - 16);
        } catch (Exception e) {
            e.printStackTrace();
        }
